...
//            cell.btnRadioButton.addTarget(self, action: #selector(btnRadioTapped(sender:)), for: .touchUpInside)
        }
        return cell
    }
//    @objc func btnRadioTapped(sender: UIButton) {
//        if let tableView = tbvPostAudience {
//            for cell in tableView.visibleCells {
//                if let customCell = cell as? PostAudienceCell {
//
//                    if customCell.btnRadioButton.tag == sender.tag {
//                        customCell.btnRadioButton.isSelected = true
//                    }
//                    else {
//                        customCell.btnRadioButton.isSelected = false
//                    }
//                }
//            }
//            
...
extension UpdateShareLevel: UITableViewDelegate {
    ...
    @objc func didTapButtonSave(sender: UIButton) {
        ...
        vc?.postAudience = self.selectData
        if delegate != nil {
